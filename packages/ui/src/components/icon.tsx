...
const PATHS: Record<string, string> = {
  ...
  bell: "M18 9a6 6 0 00-12 0c0 6-2.5 7.5-2.5 7.5h17S18 15 18 9zM9.5 20h5",
  ...
  eye: "M2.5 12s3.5-6 9.5-6 9.5 6 9.5 6-3.5 6-9.5 6S2.5 12 2.5 12zM12 15a3 3 0 100-6 3 3 0 000 6z",
  "eye-off":
    "M3 3l18 18M10.6 6.2A9.8 9.8 0 0112 6c6 0 9.5 6 9.5 6a14 14 0 01-2.4 3.1M6.2 6.2C3.8 7.8 2.5 12 2.5 12s3.5 6 9.5 6c1.3 0 2.4-.3 3.4-.7M9.9 9.9A3 3 0 0014.1 14",
