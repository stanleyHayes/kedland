...
/**
 * The school's page copy, from build package §4.
 *
 * **This text is final and approved.** The package is explicit: do not
 * paraphrase or "improve" it without sign-off — it is written in the school's
 * own voice. Anything marked `[PENDING — client]` in the package is either
 * carried over as the package's placeholder or noted here; the punch list in
 * agent_plan §11 tracks what is still owed.
 *
 * Shape is enforced by the registry's Zod schemas: `content.seed.spec.ts` runs
 * every entry below through `validateSectionData`, so a typo here fails the
 * build rather than reaching a page.
 */
export type SeedSections = Record<string, Record<string, unknown>>;
export type SeedContent = Partial<Record<PageKey, SeedSections>>;

/** Repeated verbatim on most pages, per build package §3. */
const CTA_BANNER = {
...
/** The seven values that spell the school's name (§4.2b). */
const KEDLAND_VALUES = [
...
/** The levels actually open. §4.3b: do not advertise levels that are not. */
const LEVELS = [
  {
    icon: "baby",
  ...
  { icon: "blocks", name: "Nursery 1", blurb: "Curious hands, first friendships and plenty of songs." },
  { icon: "palette", name: "Nursery 2", blurb: "Discovering letters, numbers and how things work." },
  { icon: "star", name: "Reception", blurb: "Getting ready for school, one confident step at a time." },
  { icon: "book", name: "Primary", blurb: "Cambridge Primary — inquiry, ideas and a love of learning." },
];
...
export const CONTENT_SEED: SeedContent = {
  home: {
    hero: {
      ...
      primaryCta: { label: "Enrol Now", href: "/admissions" },
      secondaryCta: { label: "Book a Tour", href: "/contact" },
      // PLACEHOLDER per §4.1 — replaced when the school's photography arrives.
      image: { mediaId: "placeholder-hero", alt: "Happy young pupils at Kedland International School" },
      trustChips: [
    ...
    values: {
      ...
      tiles: KEDLAND_VALUES,
      cta: { label: "Meet our values", href: "/about/mission-vision-values" },
    },
    principal: {
      portrait: { mediaId: "principal-portrait", alt: "the Principal of Kedland International School" },
      quote:
      ...
      cta: { label: "A message from our Principal", href: "/about/principal" },
    },
    instagram: { heading: "Life at Kedland", handle: "@kedlandintlschool" },
  ...
  "about/mission-vision-values": {
    ...
    values: {
      heading: "Our values — they spell our name",
      tiles: KEDLAND_VALUES,
  ...
  "about/facilities": {
    ...
    facilities: {
      ...
      // PENDING — client: confirm this list and supply photographs (§4.2d).
      items: [
        { icon: "book", label: "Classrooms" },
        { icon: "book", label: "Library & reading corner" },
        { icon: "monitor", label: "ICT suite" },
        { icon: "music", label: "Music room" },
        { icon: "sparkle", label: "Science & discovery area" },
        { icon: "sun", label: "Outdoor play area" },
        { icon: "palette", label: "Art & activity centres" },
        { icon: "utensils", label: "Dining & canteen" },
        { icon: "shield", label: "Safe pickup zone" },
      ],
    },
    "cta-banner": CTA_BANNER,
  },
  ...
  "academics/primary": {
    intro: {
      ...
      standfirst: "Primary, with room to grow.",
      image: {
        mediaId: "kedland-starter-discovery-table",
  ...
  admissions: {
    hero: {
      ...
      heading: "Admissions are open — begin your child's journey",
      subheading: "We'd love to welcome your little Star to the Kedland family.",
      primaryCta: { label: "Download the form", href: "/admissions" },
      secondaryCta: { label: "Enquire / Book a Tour", href: "/contact" },
    ...
    fees: {
      heading: "Fees",
      body: "For current fees and available spaces, please contact our admissions team — we're happy to help. Call or message us and we will talk you through everything.",
  ...
  "student-life": {
    ...
    day: {
      ...
      // PLACEHOLDER per §4.5 — confirm the real routine with the school.
      moments: [
        {
          icon: "sun",
          title: "Warm welcome",
      ...
      cards: [
        {
          icon: "palette",
          title: "Art & design",
          body: "A rich environment for creativity, where children are encouraged to make, imagine and try.",
        },
        {
          icon: "music",
          title: "Music",
          body: "A well-furnished music room with instruments, because music builds memory, focus and togetherness.",
        },
        {
          icon: "sun",
          title: "Active play & sport",
          body: "Plenty of room to run, climb and play — healthy habits start early.",
        },
      ],
    },
    care: {
      heading: "Care for busy families",
      body: "We know families are busy. Kedland offers an After-School Service and Weekend Drop-Off, giving your child a safe, engaging and caring place to be — with people they know and trust.",
  ...
  privacy: {
    notice: {
      ...
      // PENDING — client: this wording needs the school's approval before launch
      // (build package §6.6 and the punch list). It is deliberately plain and
